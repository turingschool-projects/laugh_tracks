...
describe "Comedians index page" do
  ...
  describe "When I visit /comedians" do
    ...
    it "there is a list of ages for available comedians, all links to page sorted by that age" do
      ...
      expect(page).to_not have_content(@comedian_1.birthplace)
      expect(page).to_not have_content(@comedian_1.name)
      ...
      expect(page).to have_content(comedian_4.birthplace)
      expect(page).to have_content(comedian_4.name)
    end
  end
end
